...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, dropout=0.2, name='rnn2'), merge_mode='concat')(input_data)
    # Add a TimeDistributed(Dense(output_dim)) layer
...
def extra_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, dropout=0.1, name=''.join(['rnn', str(i)])), merge_mode='concat')(layer)
